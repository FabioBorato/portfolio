    ...
    return(
        <div>
            ...
            <ul className="re-size">
                ...
                <br/><p>O <strong>Marketing</strong>, quando buscava construir na mente humana a ideia de algo, levando como base a sua compreensão.</p>
                ...
                <br/><p> Hoje, retorno ao mundo tech, trazendo comigo uma bagagem rica e eclética, pronta para enfrentar desafios com uma perspectiva renovada. Minha história é uma fusão de resiliência, aprendizado contínuo e uma incansável busca por transformação.</p>
